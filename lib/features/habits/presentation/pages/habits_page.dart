                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                                '${state.completedCount} / ${state.totalCount} habits',
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                child: habit.done
                                    ? Icon(Icons.check,
                                        color: habit.color, size: 28)
                                    : Icon(habit.icon,
                                        color: habit.color, size: 26),
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(' ${habit.streak} days showing up',
                                          style: const TextStyle(
                                              fontSize: 12,
                                              color: Colors.grey)),
                                    ],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ref
                        .read(habitsProvider.notifier)
                        .addHabit(title: name, color: selectedColor);
