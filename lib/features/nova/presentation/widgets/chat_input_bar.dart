...
class _ChatInputBarState extends State<ChatInputBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final barBgColor = isDark ? AppTheme.darkBg : AppTheme.lightBg;
    final fieldBgColor = isDark ? AppTheme.darkSurface : Colors.white;
          ...
          PremiumBounceInteraction(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: _hasText ? Colors.transparent : borderColor),
              ),
              child: Icon(
