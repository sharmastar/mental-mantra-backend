            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Sun Salutation Flow',
                      style: theme.textTheme.titleLarge?.copyWith(
                          color: Colors.white, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 4),
                  const Text('15 min • Beginner',
            ...
            return Container(
              ...
              child: ListTile(
                leading: Container(
                  ...
                  child: Center(
                      child: Text(pose['image'] as String,
                          style: const TextStyle(fontSize: 22))),
                ),
                title: Text(pose['name'] as String,
                    style: const TextStyle(fontWeight: FontWeight.w600)),
                subtitle: Text(pose['sanskrit'] as String,
                    style: const TextStyle(fontSize: 12, color: Colors.grey)),
                trailing: Text(pose['duration'] as String,
