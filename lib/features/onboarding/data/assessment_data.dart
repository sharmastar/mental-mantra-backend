...
class AssessmentData {
  ...
  static List<AssessmentQuestion> get questions => [
        ...
        const AssessmentQuestion(
          ...
          subtitle:
              "This helps us understand the depth of what you're going through.",
        ...
        const AssessmentQuestion(
          ...
          question:
              "Over the past 2 weeks, how often have you felt mentally overwhelmed?",
        ...
        const AssessmentQuestion(
          id: 'excessive_worry',
          question:
              "How often have you experienced excessive worrying or overthinking?",
          type: 'frequency_scale',
          options: ['Never', 'Rarely', 'Sometimes', 'Often', 'Almost Always'],
        ...
        const AssessmentQuestion(
          ...
          question:
              "Do you feel you have someone you can openly talk to emotionally?",
          type: 'single_select',
        ...
        const AssessmentQuestion(
          id: 'habit_struggles',
          question:
              "Have you struggled with any of these habits becoming difficult to control?",
          type: 'multi_select',
          options: [
        ...
        const AssessmentQuestion(
          ...
          encouragementAfter:
              "Understanding your patterns helps us help you better 🌱",
        ),
        ...
        const AssessmentQuestion(
          ...
          question:
              "What would you most like to improve through Mental Mantra?",
          type: 'multi_select',
          options: [
            'Reduce stress',
            'Reduce anxiety',
  ...
  static final Map<String, AssessmentQuestion> _followUpQuestions = {
    'addiction_severity': const AssessmentQuestion(
      ...
      question:
          'How strongly do these habits affect your daily life or emotional wellbeing?',
      type: 'single_select',
  ...
  static AssessmentQuestion? getAdaptiveQuestion(String id) =>
      _followUpQuestions[id];
  ...
  static List<String> getAdaptiveFollowUps(Map<String, dynamic> answers) {
    ...
    if (answers['sleep_quality'] == 'Poor' ||
        answers['sleep_quality'] == 'Very poor') {
