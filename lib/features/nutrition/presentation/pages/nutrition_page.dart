...
class NutritionPage extends ConsumerWidget {
              ...
              background: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [AppTheme.secondaryColor, AppTheme.primaryDark],
              ...
              return GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(ctx).showSnackBar(SnackBar(
                    content:
                        Text('${action.title}: ${action.tip ?? action.body}'),
  ...
  Widget _buildHydrationTracker(
      NutritionState state, WidgetRef ref, bool isDark) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        gradient: LinearGradient(
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text('${state.waterGlasses} / 8 glasses',
                  style: TextStyle(
                    fontSize: 13,
                    color: isDark ? Colors.white60 : Colors.black54,
                  )),
          ...
          Text(
            state.waterGlasses >= 8
                ...
                : 'Tip: Keep a water bottle nearby as a gentle reminder',
            style: TextStyle(
              fontSize: 12,
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView(
            scrollDirection: Axis.horizontal,
            children: WellnessCategory.values
                .where((c) => c != WellnessCategory.energyFoods)
                .map((cat) {
              final isSelected = state.selectedCategory == cat;
              return GestureDetector(
                onTap: () =>
                    ref.read(nutritionProvider.notifier).selectCategory(cat),
                child: Container(
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isDark
                  ? AppTheme.darkBorder
                  : tip.category.color.withValues(alpha: 0.15),
            ),
          ),
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
