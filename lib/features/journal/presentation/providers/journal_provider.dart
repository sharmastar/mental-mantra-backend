...
final journalListProvider = FutureProvider.family<List<JournalEntry>, String>((ref, userId) async {
  final repo = ref.watch(journalRepositoryProvider);
  return repo.getEntries();
});

final journalStatsProvider = FutureProvider.family<Map<String, dynamic>, String>((ref, userId) async {
  final repo = ref.watch(journalRepositoryProvider);
...
class JournalEntryNotifier extends StateNotifier<AsyncValue<JournalEntry?>> {
  ...
  Future<void> saveAiAnalysis(String entryId, Map<String, dynamic> analysis) async {
