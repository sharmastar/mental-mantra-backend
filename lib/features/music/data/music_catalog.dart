    ...
    final catData = [
      {
        ...
        'prefixes': ['396 Hz', '417 Hz', '528 Hz', '639 Hz', '741 Hz', '852 Hz', '963 Hz'],
        'suffixes': ['Deep Healing', 'DNA Repair', 'Connection & Relationships', 'Awakening Intuition', 'Pure Aura Cleanse', 'Divine Alignment', 'Vibrational Shift'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Gentle Rain', 'Forest Birds', 'Ocean Waves', 'Thunderstorm', 'Mountain River', 'Wind in Pines', 'Summer Night Crickets'],
        'suffixes': ['in Wilderness', 'at Dawn', 'for Sleep', 'with Soft Winds', 'Deep Relaxation', 'Calm Escape', 'Pure Sleep Sounds'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Delta Waves', 'Theta Waves', 'Alpha Waves', 'Beta Waves', 'Gamma Waves', 'Deep Sleep Beats', 'Focus Entrainment'],
        'suffixes': ['for Deep Sleep', 'for Astral Projection', 'for High Focus', 'for Learning', 'for Brain Power', 'for Relaxation', 'for Anxiety Relief'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Deep Focus Piano', 'Ambient Electronic', 'Lo-Fi Study Beats', 'Chill Synthwave', 'Acoustic Focus', 'Coding Flow', 'Zen Workspace'],
        'suffixes': ['Volume 1', 'Session A', 'for Coding', 'for Reading', 'for Writing', 'Peak Performance', 'Productive Hour'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Tranquil Piano', 'Zen Flute', 'Harp Dreams', 'Cello Serenity', 'Ambient Guitar', 'Tibetan Bowls', 'Crystal Chimes'],
        'suffixes': ['for Mind Unwind', 'in Sanctuary', 'of Peace', 'of Hope', 'for Relaxation', 'for Deep Calm', 'for Meditation'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Sunrise Awakening', 'Positive Vibes', 'Energizing Drums', 'Morning Uplift', 'Joyful Spirit', 'Gentle Sunlight', 'Radiant Morning'],
        'suffixes': ['to Start the Day', 'for Vitality', 'for Workout', 'for Yoga', 'for Mind Reset', 'Volume 2', 'Session 1'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['White Noise', 'Pink Noise', 'Brown Noise', 'Grey Noise', 'Fan Sound', 'Airplane Cabin', 'Heavy Static'],
        'suffixes': ['for Baby Sleep', 'for Deep Sleep', 'for Focus', 'for Restless Minds', 'Calming Stream', 'Continuous Loop', 'Relaxing Fan'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Cosmic Void', 'Nebula Drift', 'Andromeda Wave', 'Stellar Echoes', 'Quantum Calm', 'Space Flight', 'Deep Abyss'],
        'suffixes': ['Meditation', 'Soundtrack', 'Atmosphere', 'Soundscape', 'Voyage', 'Harmony', 'Drones'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Himalayan Resonance', 'Singing Bowls', 'Temple Chants', 'Monastery Silence', 'Zen Resonance', 'Bronze Bowl Harmonics', 'Chakra Bowls'],
        'suffixes': ['for Purification', 'for Cleansing', 'for Inner Peace', 'for Meditation', 'for Healing', 'for Alignment', 'for Yoga'],
        'baseUrls': [
      ...
      },
      {
        ...
        'prefixes': ['Root Chakra Grounding', 'Sacral Chakra Flow', 'Solar Plexus Power', 'Heart Chakra Healing', 'Throat Chakra Truth', 'Third Eye Intuition', 'Crown Chakra Connection'],
        'suffixes': ['Sound Therapy', 'Alignment Session', 'Frequency Balance', 'Meditation Music', 'Binaural Tuning', 'Energy Clearing', 'Vibration Activation'],
        'baseUrls': [
