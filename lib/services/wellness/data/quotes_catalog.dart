class QuotesCatalog {
  ...
  static List<Map<String, String>> get allQuotes {
    ...
    final realQuotes = [
      ...
      {'text': 'Rest when you\'re weary. Refresh and renew yourself. Your body and mind will thank you.', 'author': 'Lailah Gifty Akita'},
      {'text': 'Breathe. Let go. And remind yourself that this very moment is the only one you know you have.', 'author': 'Oprah Winfrey'},
      ...
      {'text': 'No limit exists to the power of the human mind. The more concentrated it is, the more power is brought to bear on one point.', 'author': 'Swami Vivekananda'},
      ...
      {'text': 'Do not lose yourself in the past. Do not lose yourself in the future. Anchor yourself here.', 'author': 'Thich Nhat Hanh'},
      {'text': 'The soul always knows what to do to heal itself. The challenge is to silence the mind.', 'author': 'Caroline Myss'},
      {'text': 'To walk safely through the maze of human life, one needs the light of wisdom and the guidance of virtue.', 'author': 'Buddha'},
      ...
      {'text': 'Do your practice and all is coming.', 'author': 'Sri K. Pattabhi Jois'},
      {'text': 'Tension is who you think you should be. Relaxation is who you are.', 'author': 'Chinese Proverb'},
      {'text': 'With every breath, I release the old and welcome the new.', 'author': 'Unknown'},
      {'text': 'Self-compassion is simply giving ourselves the same kindness we would give others.', 'author': 'Kristin Neff'},
      {'text': 'We are what we repeatedly do. Excellence, then, is not an act, but a habit.', 'author': 'Aristotle'},
      {'text': 'The secret of change is to focus all of your energy not on fighting the old, but on building the new.', 'author': 'Socrates'},
      {'text': 'One small positive thought in the morning can change your entire day.', 'author': 'Unknown'},
      ...
      {'text': 'In the practice of tolerance, one\'s enemy is the best teacher.', 'author': 'Dalai Lama'},
      ...
      {'text': 'Wisdom comes from reflecting on experience, not just having it.', 'author': 'Unknown'},
      ...
      {'text': 'Do not look for sanctuary in anyone except yourself.', 'author': 'Buddha'},
      {'text': 'The only real failure in life is not to be true to the best one knows.', 'author': 'Buddha'},
      {'text': 'Purity or impurity depends on oneself, no one can purify another.', 'author': 'Buddha'},
      {'text': 'He has no fear who is not filled with anxiety.', 'author': 'Lao Tzu'},
      ...
      {'text': 'Patience is of two kinds: patience over what pains you, and patience against what covets you.', 'author': 'Ali ibn Abi Talib'},
      ...
      {'text': 'Live simple, breathe deep, and let love guide you.', 'author': 'Zen Proverb'},
      {'text': 'The obstacle is the path.', 'author': 'Zen Proverb'},
      {'text': 'Leap, and the net will appear.', 'author': 'Zen Proverb'},
      {'text': 'Knock on the sky and listen to the sound.', 'author': 'Zen Proverb'},
      ...
      {'text': 'My actions are my only true belongings. I cannot escape the consequences of my actions.', 'author': 'Thich Nhat Hanh'},
      ...
      {'text': 'Life is available only in the present.', 'author': 'Thich Nhat Hanh'},
    ];
    ...
    final authors = [
      'Zen Wisdom', 'Marcus Aurelius', 'Sufi Proverb', 'Lao Tzu', 'Buddha',
      'Stoic Philosophy', 'Yogi Teachings', 'Eastern Philosophy', 'Mental Mantra Coach'
    ];
